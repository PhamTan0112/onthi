...
import com.phamphutan.Adapter.SachAdapter;
import com.phamphutan.Database.SachDB;
import com.phamphutan.Model.Sach;
import com.phamphutan.cau5.databinding.ActivityCau2Binding;
                ...
                btnSave.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!maList.contains(ma)) {
                            db.execSQL(
                                    "INSERT INTO " + db.TBL_NAME + " VALUES('" + ma + "','" + ten + "'," + gia + ")");
                            loadData();
                            dialog.dismiss();
                        } else {
